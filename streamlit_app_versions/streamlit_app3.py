...
if user_id:
    if check_user_id(int(user_id)):
        ...
        districts = ['Mitte', 'Friedrichshain_Kreuzberg', 'Panow', 'Charlottenburg-Wilmersdorf', 'Spandau', 'Steglitz-Zehlendorf', 'Tempelhof-Schöneberg',
                      'Neukölln', 'Treptow-Köpenick', 'Marzahn-Hellersdorf', 'Lichtenberg', 'Reinickendorf']



        # Define the districts and neighborhoods
        neighborhoods = {
            ...
            'Steglitz-Zehlendorf': ['Steglitz','Lichterfelde','Lankwitz','Zehlendorf','Dahlem','Nikolassee','Wannsee','Schlachtensee'],
        ...
        for district in selected_districts:
            selected_neighborhoods.extend(neighborhoods.get(district, []))

        # if pd.isnull(selected_neighborhoods):
        #     selected_neighborhoods = neighborhoods
        # Display the neighborhood selector
        selected_neighborhoods = st.sidebar.multiselect('Select Neighborhoods', selected_neighborhoods, default=selected_neighborhoods)
